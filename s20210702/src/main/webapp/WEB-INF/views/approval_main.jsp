...
<%@ include file="/WEB-INF/viewpart/header.jsp"%>
	...
	<div id="wmcontainer1">
	 ...
	 <table>
	 <tr>
	 <th> <a href="app_writeForm1?mem_no=${mo.mem_no }"><img alt="yc_icon" src="img/yc_icon.png" width=" 130px"></a> 	 </th>
	 ...
	 <th> <a href="app_my_list2?mem_no=${mo.mem_no }&currentPage=1"><img alt="my_appr2" src="img/my_appr2.png" width=" 150px"></a>	 </th>
	  ...
	  <tr>
	  <th>연차 결재 신청</th><th>출장 신청</th><th>기타 일반 결재 신정</th><th>내가 상신한 결재 목록 보기</th><th>내가 결재할 목록 보기</th>
	  </tr>
