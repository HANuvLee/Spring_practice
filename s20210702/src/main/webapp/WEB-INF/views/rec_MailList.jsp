...
<div id="table">
 	<c:forEach var="mail" items="${listMail }">
		<div class="row">
			...
			<span class="cell col2"><a href="mailDetail?mail_no=${mail.mail_no }&mail_receiver=${mail.mail_receiver}">${mail.mail_title}</a></span> 
...
<c:forEach var="i" begin="${pg.startPage }" end="${pg.endPage }">
	<a href="rec_mailList?currentPage=${i}&mem_id=${member.mem_id}">[${i}]</a>
</c:forEach>
