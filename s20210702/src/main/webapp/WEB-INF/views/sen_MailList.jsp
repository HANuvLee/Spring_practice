...
<div id="table">
 ...
 <c:if test="${pg.startPage > pg.pageBlock }">
   <a href="sen_mailList?currentPage=${pg.startPage-pg.pageBlock}">[이전]</a>
</c:if>
<c:forEach var="i" begin="${pg.startPage }" end="${pg.endPage }">
   <a href="sen_mailList?currentPage=${i}">[${i}]</a>
</c:forEach>
<c:if test="${pg.endPage < pg.totalPage }">
   <a href="sen_mailList?currentPage=${pg.startPage+pg.pageBlock}">[다음]</a>
</c:if>
</body>
</html>